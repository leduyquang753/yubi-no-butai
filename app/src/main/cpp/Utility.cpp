...
float* Utility::buildOrthographicMatrix(
	float *const outMatrix, const float halfHeight, const float aspect, const float near, const float far
) {
...
float* Utility::buildIdentityMatrix(float *const outMatrix) {
	// column 1
	outMatrix[0] = 1.f;
	outMatrix[1] = 0.f;
	outMatrix[2] = 0.f;
